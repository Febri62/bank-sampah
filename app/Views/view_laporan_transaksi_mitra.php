...
<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-item has-treeview menu-open">
        ...
        <ul class="nav nav-treeview ">
            ...
            <li class="nav-item">
                <a href="<?= base_url('mitra/laporan-transaksi'); ?>" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
...
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            <div class="card">
                <form action="<?= base_url('LaporanMitraController/mitrapenjualan'); ?>" target="__blank" method="POST">
        ...
        <div class="col-sm-6">
            <div class="card">
                <form action="<?= base_url('LaporanMitraController/mitrapenarikan'); ?>" target="__blank" method="POST">
                    <div class="card-header">
