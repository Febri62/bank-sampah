                    ...
                    foreach ($kategori as $row) : $no++ ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a data-toggle="modal" data-target="#updateModal<?= $row['kategori_id']; ?>" class="btn-sm btn-success btn-update"><i class="fa fa-edit"></i></a>
                                <a class="btn-sm btn-danger btn-delete" data-toggle="modal" data-target="#deleteModal<?= $row['kategori_id']; ?>"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
