...
<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-item has-treeview menu-open">
        ...
        <ul class="nav nav-treeview ">
            <li class="nav-item">
                <a href="<?= base_url('mitra/laporan-master'); ?>" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Laporan Master</p>
                </a>
            </li>
...
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            <div class="card">
                <form action="<?= base_url('LaporanMitraController/sampahmasuk'); ?>" method="POST" target="_blank">
                    <div class="card-header">
                        <h5>Laporan Sampah Masuk</h5>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <select name="kategori" id="kategori" class="form-control">
                            ...
                            <option value="2">Sampah An Organik</option>
                        </select>
                    </div>
                    <div class="card-footer">
                        <button type="submit" target="_blank" onclick="pegawaiperbulan()"
                            class="btn btn-primary float-right">Cetak</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="card">
                <form action="<?= base_url('LaporanMitraController/sampahmasukperbulan'); ?>" method="POST" target="_blank">
                    <div class="card-header">
                        <h5>Laporan Sampah Masuk</h5>
                    </div>
