...
<div class="container">
    <div class="card">
        ...
        <div class="card-header">
            ...
            <a href="<?= base_url('administrator/report'); ?>" target="__blank" class="btn btn-sm btn-info"><i class="fa fa-print mr-2"></i> Cetak</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                ...
                <tbody>
                    ...
                    foreach ($administrator as $row) : $no++ ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($row['administrator_role'] == 2) { ?>
                                    <span class="badge bg-success">Pimpinan</span>
                                <?php } else if ($row['administrator_role'] == 1) { ?>
                            ...
                            <td style="text-align: center;">
                                <a data-toggle="modal" data-target="#updateModal<?= $row['administrator_id']; ?>" class="btn-sm btn-success"><i class="fa fa-edit"></i></a>
                                <a class="btn-sm btn-danger btn-delete" data-toggle="modal" data-target="#deleteModal<?= $row['administrator_id']; ?>"><i class="fa fa-trash"></i></a>
                                <a class="btn-sm btn-success btn-update" data-toggle="modal" data-target="#resetModal<?= $row['administrator_id']; ?>"><i class="fa fa-unlock"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label>Email</label>
                                <input type="email" class="form-control <?= ($validation->hasError('email')) ? 'is-invalid' : ''; ?>" placeholder="Masukan email" id="email" name="email" required autocomplete="off">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label>Nama</label>
                                <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" placeholder="Masukan nama" id="nama" name="nama" required autocomplete="off">
                                <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control <?= ($validation->hasError('password')) ? 'is-invalid' : ''; ?>" placeholder="Masukan password" id="password" name="password" required autocomplete="off">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label>Role</label>
                                <select name="role" id="role" required class="form-control <?= ($validation->hasError('role')) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label>Status</label>
                                <select name="status" id="status" required class="form-control <?= ($validation->hasError('status')) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label>Email</label>
                                    <input type="email" readonly value="<?= $row['administrator_email']; ?>" class="form-control <?= ($validation->hasError('email')) ? 'is-invalid' : ''; ?>" placeholder="Masukan email" id="email" name="email" required autocomplete="off">
                                    <div class="invalid-feedback">
                                        <?= $validation->getError('email'); ?>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label>Nama</label>
                                    <input type="text" value="<?= $row['administrator_nama']; ?>" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" placeholder="Masukan nama" id="nama" name="nama" required autocomplete="off">
                                    <div class="invalid-feedback">
                                        <?= $validation->getError('nama'); ?>
                                    </div>
                                </div>
