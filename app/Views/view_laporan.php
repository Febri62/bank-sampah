...
<div class="container">
    <div class="row">
        <!-- <div class="col-sm-4">
            <div class="card">
                <form action="<?= base_url('nasabahperbulan'); ?>" method="POST">
        ...
        <div class="col-sm-4">
            <div class="card">
                <form action="<?= base_url('mitraperbulan'); ?>" method="POST">
                    <div class="card-header">
                        <h5>Laporan Mitra</h5>
                    </div>
                    <div class="card-body">
        ...
        <!-- <div class="col-sm-4">
            <div class="card">
                <form action="<?= base_url('sampahperbulan'); ?>" method="POST">
                    <div class="card-header">
        ...
        <div class="col-sm-6">
            <div class="card">
                <form action="<?= base_url('LaporanController/sampahmasuk'); ?>" target="__blank" method="POST">
        ...
        <div class="col-sm-6">
            <div class="card">
                <form action="<?= base_url('LaporanController/sampahmasukperbulan'); ?>" target="__blank" method="POST">
