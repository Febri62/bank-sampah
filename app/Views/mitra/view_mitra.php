    ...
    <div class="card">
        ...
        <div class="card-header">
            <!-- <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#addModal"><i
                ...
                <a href="<?= base_url('tambah_data_mitra') ?>" class="btn btn-sm btn-success" ><i class="fa fa-plus mr-2"></i> Data Baru</a>
            <a href="<?= base_url('mitra/report'); ?>" target="__blank" class="btn btn-sm btn-info"><i
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a type="button" data-toggle="modal" data-target="#updateModal<?= $row['mitra_id']; ?>"
                                class="btn-sm btn-success"><i class="fa fa-edit"></i></a>
                            <a type="button" class="btn-sm btn-danger btn-delete" data-toggle="modal"
                                data-target="#deleteModal<?= $row['mitra_id']; ?>"><i class="fa fa-trash"></i></a>
                            <a type="button" class="btn-sm btn-success btn-update" data-toggle="modal"
                                data-target="#resetModal<?= $row['mitra_id']; ?>"><i class="fa fa-unlock"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
...
<form action="<?= base_url('mitra/edit'); ?>" enctype="multipart/form-data" method="POST">
    <?= csrf_field(); ?>
    <div class="modal fade" id="updateModal<?= $row['mitra_id']; ?>" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg modal-dialog-scrollabel" role="document">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label>Email</label>
                                <input type="email" readonly value="<?= $row['mitra_email']; ?>"
                                    class="form-control "
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label>Nama</label>
                                <input type="text" value="<?= $row['mitra_nama']; ?>"
                                    class="form-control "
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" value="<?= $row['mitra_nohp']; ?>"
                                    class="form-control "
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" value="<?= $row['mitra_direktur']; ?>"
                                    class="form-control "
                                    placeholder="Masukan nama Direktur" id="direktur" name="direktur" required autocomplete="off">
                                <div class="invalid-feedback">
...
<form action="<?= base_url('mitra/mitra/reset'); ?>" enctype="multipart/form-data" method="POST">
    <?= csrf_field(); ?>
    <div class="modal" tabindex="-1" id="resetModal<?= $row['mitra_id']; ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" name="id" required value="<?= $row['mitra_id']; ?>" />
                    <h6>Password <strong><?= $row['mitra_nama']; ?></strong> akan di reset menjadi '1234'</h6>
                </div>
                <div class="modal-footer">
